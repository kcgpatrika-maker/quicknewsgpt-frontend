  ...
  return (
    ...
    >
      ...
      >
        <input
          className="ask-input"
          placeholder="à¤•à¥�à¤µà¤¿à¤• à¤¨à¥�à¤¯à¥‚à¤œà¤¼ GPT à¤¸à¥‡ à¤ªà¥‚à¤›à¥‡à¤‚..."
          value={q}
      ...
      <div>
        {results === null && (
          <div style={{ color: "#6b7280" }}>
            à¤•à¥‹à¤ˆ à¤µà¤¿à¤·à¤¯ à¤Ÿà¤¾à¤‡à¤ª à¤•à¤°à¥‡à¤‚ (à¤œà¥ˆà¤¸à¥‡ à¤¦à¤¿à¤²à¥�à¤²à¥€, à¤¬à¤¿à¤¹à¤¾à¤°, AI...) â€” à¤”à¤° à¤•à¥�à¤µà¤¿à¤• à¤œà¤µà¤¾à¤¬ à¤ªà¤¾à¤�à¤‚à¥¤
          </div>
        )}
